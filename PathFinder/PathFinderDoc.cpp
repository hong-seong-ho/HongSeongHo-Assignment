...
// PathFinderDoc.cpp: CPathFinderDoc 클래스의 구현
//
...
// CPathFinderDoc 생성/소멸

CPathFinderDoc::CPathFinderDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CPathFinderDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CPathFinderDoc::InitializeSearchContent()
{
...
void CPathFinderDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
